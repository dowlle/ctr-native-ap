...
// Kart and direct-projectile contact radius in LEV world units. A standing
// retail-sized AP crate has its centre 54 units above the road, so radius 110
// gives about 96 units of horizontal reach: sqrt(110^2 - 54^2). This restores
// more forgiving collection after the box anchor correction reduced that
// reach to about 79 units with radius 96.
//
// LinkedCollide_Radius takes a squared radius; projectile segment contact
// takes the linear value. Weapon explosions keep their own blast radius.
// This remains a sphere around the visible box centre, not a placement change.
#define AP_BOX_HIT_RADIUS         0x6e
