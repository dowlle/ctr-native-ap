...
#define _gte_dotProduct_GTE_ROW_INDEX_0_GTE_CALC_INT(out, matrixType, vecType) \
	gte_mvmva(0, matrixType, vecType, 3, 0);                                   \
	_gte_readMac_GTE_MAC_1(out)
#define _gte_dotProduct_GTE_ROW_INDEX_1_GTE_CALC_INT(out, matrixType, vecType) \
	gte_mvmva(0, matrixType, vecType, 3, 0);                                   \
	_gte_readMac_GTE_MAC_2(out)
#define _gte_dotProduct_GTE_ROW_INDEX_2_GTE_CALC_INT(out, matrixType, vecType) \
	gte_mvmva(0, matrixType, vecType, 3, 0);                                   \
	_gte_readMac_GTE_MAC_3(out)
#define _gte_dotProduct_GTE_ROW_INDEX_0_GTE_CALC_FLOATING_POINT(out, matrixType, vecType) \
	gte_mvmva(1, matrixType, vecType, 3, 0);                                              \
	_gte_readMac_GTE_MAC_1(out)
#define _gte_dotProduct_GTE_ROW_INDEX_1_GTE_CALC_FLOATING_POINT(out, matrixType, vecType) \
	gte_mvmva(1, matrixType, vecType, 3, 0);                                              \
	_gte_readMac_GTE_MAC_2(out)
#define _gte_dotProduct_GTE_ROW_INDEX_2_GTE_CALC_FLOATING_POINT(out, matrixType, vecType) \
	gte_mvmva(1, matrixType, vecType, 3, 0);                                              \
	_gte_readMac_GTE_MAC_3(out)
#define _gte_mulMatrixVec(out, matrixType, vecType, shift) \
	gte_mvmva(shift, matrixType, vecType, 3, 0);           \
	_gte_readMac_GTE_VECTOR_MAC(out)
...
#define gte_interpolate(out, calcType)  \
	CAT(_gte_interpolate_, calcType)(); \
	_gte_readMac_GTE_VECTOR_MAC(out)
#define gte_interpolateBase(out, calcType)  \
	CAT(_gte_interpolateBase_, calcType)(); \
	_gte_readMac_GTE_VECTOR_MAC(out)
#define gte_crossProduct(out, matrix, vector) \
	gte_SetRotMatrix(matrix);                 \
	gte_loadSVec(vector, GTE_VECTOR_IR);      \
	gte_op0();                                \
	gte_readMac(out, GTE_VECTOR_MAC)
