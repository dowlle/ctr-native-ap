...
{
	*((volatile const char **const)0x1f802084) = msg;
}
force_inline void pcsx_checkKernel(int enable)
{
	*((volatile char *)0x1f802088) = enable;
}
force_inline int pcsx_isCheckingKernel()
{
	return *((volatile char *const)0x1f802088) != 0;
}
