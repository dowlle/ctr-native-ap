...
You need three things: a release build, your own (NTSC-U) copy of the game, and your room details. The full walkthrough (including the recommended asset extractor) is in [SETUP.md](SETUP.md); the short version:
