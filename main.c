...
int main(int argc, char *argv[])
{
	...
	// status. An accepted request is deliberately NOT acted on yet: the disc
	// wizard, pending handoff, Steam routing and registration are later slices.
	// No URI, command line or rejected field value ever reaches the output.
	for (int argIndex = 1; argIndex < argc; argIndex++)
	{
...

		{
			...
			if (launchStatus == NATIVE_LAUNCH_REQUEST_OK)
				printf("[CTR-AP] launch request accepted (not acted on)\n");
			else
