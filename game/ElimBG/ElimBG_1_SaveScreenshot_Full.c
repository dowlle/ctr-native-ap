...
#define STRIP_H 8
	...
	for (rDst.y = 0; rDst.y < (0xd8 - STRIP_H); rDst.y += STRIP_H)
	{
		...
		DECOMP_ElimBG_SaveScreenshot_Chunk((u_short *)sdata->PausePtrsVRAM[4 + (1 - iVar4)], (u_short *)sdata->PausePtrsVRAM[2 + (1 - iVar4)], 0x1000);
	...
	DECOMP_ElimBG_SaveScreenshot_Chunk((u_short *)sdata->PausePtrsVRAM[4 + (iVar4)], (u_short *)sdata->PausePtrsVRAM[2 + (iVar4)], 0x1000);
